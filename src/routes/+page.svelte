...
<div class="container mx-auto max-w-5xl p-6">
    ...
    {:then events}
        {#if events.length === 0}
            <p class="text-gray-300 mt-6">No events available yet. Click "Add Event" above to get started!</p>
        {:else}
            <!-- Search Bar -->
                        ...
                        {#each events as event}
                            <div class="card bg-base-100 border border-indigo-900 shadow-md p-4">
                                <h2 class="text-lg font-bold">
                                    <a href="/{event.id}" class="text-primary hover:underline">
